...
namespace SearchListView
{
    public class MainPageViewModel : ViewModelBase
    {
        ...
        private ObservableCollection<object> _SortItems;
        ...
        public MainPageViewModel()
        {
            ...
            SortCommand = new Command(Sortitem);
        }
        ...
        {
            _SortItems = new ObservableCollection<object>(_ItemsUnfiltered.OrderByDescending(i => (((ItemObj)i).Id )));
            Items = _SortItems;
        }
    }
